#define NGX_CONFIGURE " --builddir=objs_jit --add-module=../nginx/src/js --with-cc-opt='-Iquickjs -Wno-cast-function-type -DCONFIG_JIT' --with-ld-opt='-Lquickjs -lquickjs -lm -ldl -lpthread' --with-http_ssl_module --with-http_realip_module --with-http_sub_module --with-http_dav_module --with-http_mp4_module --with-http_random_index_module --with-http_auth_request_module --with-http_gzip_static_module --with-http_image_filter_module --with-http_xslt_module --with-http_secure_link_module --with-http_slice_module --with-http_addition_module --with-http_gunzip_module --with-stream"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 11.4.0 (Ubuntu 11.4.0-1ubuntu1~22.04.3) "
#endif
