...
### Slide 1 (Title)
From a bird's eye view. ...
The title on screen: engine X, arrow, fully programmable system. ...
Two project names: JS COM, ... and JS Pilgrim. ...
And the tagline: ...
The same reliable path browsers walked — ... now for engine X. ...
...
### Slide 8 (engine X.conf — frozen)
And here we are. ...
On screen: engine X dot conf. ...
...
Beautiful. ... Fast. ... Reliable. ...
But completely frozen. ...
Change a weight? ... Restart engine X. ...
Add a server? ... Reload the config file. ...
Respond to a runtime event? ... Limited. ...
engine X dot conf ... is our pre-DOM HTML.
...
So: what if we did to engine X ... what the DOM did to browsers? ...
Expose the entire engine X configuration as a JavaScript object tree. ...
Let scripts read it. ... Write it. ... React to it. ...
...
engine X dot version — the running version string. ...
engine X dot http dot servers, index zero, dot name — the first server's hostname. ...
engine X dot http dot servers, index zero, dot locations, index zero, dot handler — ...
assign a function, ... and it becomes the live content handler. ...
Below: change upstream peer weights ... while engine X actively serves traffic. ...
Every server. ... Every location. ... Every upstream peer. ...
Readable. ... And writable. ... Right now.
...
engine X dot setTimeout, five thousand milliseconds. ...
Fetch health scores from your own logic. ...
engine X dot suspendAllWorkers — ... every worker process pauses. ... Atomically. ...
Loop through scores: set each peer weight. ...
engine X dot resumeAllWorkers. ...
Schedule the next check. ...
Read the bold line at the bottom: ...
All workers. ... Atomically. ...
Zero downtime. ... Zero restart. ...
engine X dot conf ... never changes. ... The running system ... does.

### Slide 14 (Layer 4 — SharedWorker code)
Layer four. ... Workers and shared state. ...
engine X workers are separate OS processes. ... How do they share state? ...
On screen: two parts. ...
The SharedWorker script — hits dot js — one thread, one variable: hits. ...
On every message: increment and reply with the new total. ...
Below: any engine X worker request handler. ...
Connect to the same SharedWorker, send an empty message, get the global count back. ...
Respond with: Total hits, the number. ...
That number is the same ... across every engine X worker process. ...
Also available: SharedArrayBuffer with Atomics — lock-free shared memory between all engine X processes. ...
The quote at the bottom: ...
...
Access-phase hooks — auth, rate limiting, header injection. ...
Pre-content hooks — Koa-style middleware, composable. ...
Content handler — your JavaScript, or any classic engine X module. ...
...
Each layer is optional. ... Each layer is pure JavaScript. ...
Classic engine X modules still work — now as one layer among many.
...
The engine X event loop keeps running during any I/O wait. ...
...
engine X: fast, reliable — ... but you cannot program it. ...
The statistic below: ...
...
They want to own ... the logic layer. ...
We can give that to engine X users.
...
A/B traffic splitting: dynamic upstream weight adjustment. ...
engine X performance. ... JavaScript flexibility. ...
We do not compete with Node JS. ...
We give engine X users ... Node JS superpowers.

### Slide 19 (Backward Compatible — code + js_source)
This is the DOM lesson ... applied correctly. ...
Modern browsers still render HTML from 1995. ...
DOM extended the model. ... It did not replace it. ...
On screen: an existing engine X dot conf — unchanged. ...
...
engine X dot use, slash plugins slash rate-limiter — with configuration. ...
Window: sixty seconds. ... Limit: one thousand requests. ... Key: the API key header. ...
Second line: engine X dot use, a vendor package, pinned to version 2.1.3. ...
The bullets below: ...
Plugins loaded and unloaded ... without restart. ...
Sandboxed in their own JavaScript scope. ...
Import and export — JavaScript module system. ...
Version-pinned, registry-resolvable packages. ...
This is the npm ecosystem model — ... for engine X internals.

### Slide 21 (Admin Shell — REPL terminal)
Something remarkable. ...
A live REPL for engine X. ...
On screen: a terminal session. ...
wscat, connecting to WebSocket at localhost 9999 slash repl. ...
First query: engine X dot http dot upstreams, backend, peers zero, dot weight. ...
Answer: 5. ...
...
Like kubectl exec — ... but for engine X internals.
...
On screen: engine X dot ai dot route, the request, the model, the context, and the action. ...
Upstream health. ... User tier. ... Geographic location. ...
The AI makes a routing decision — ... directly inside the live engine X worker. ...
The sharpest tool to operate on an open heart. ...
Direct. ... Privileged. ... Real-time.
...
Starting point: static engine X dot conf. ...
...
Existing engine X dot conf: backward compatible — verified. ...
Event loop: non-blocking, zero impact on latency — architectural guarantee. ...
...
A good metaphor drives decisions faster than any design committee. ...
DOM for engine X meant every question had an obvious answer. ...
...
A quote on screen: ...
Optimization makes code more complex. ...
engine X dot conf was optimized — that is why it is frozen. ...
The COM layer is above that optimization. ...
JavaScript does not replace engine X's C internals. ...
...
Twenty twenty-six: static engine X dot conf. ...
...
The question is not whether engine X can be fully programmable. ...
It already is. ...
The question is — ... what do we build on top of it?
...
engine X dot conf ... is nineteen ninety-five HTML. ...
JS COM ... is the script tag. ...
What you build next ... is up to you.
...
| engine X problem + COM reveal | 8–10 | ~3 min |
