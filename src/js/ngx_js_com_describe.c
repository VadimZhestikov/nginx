...
static const ngx_js_member_class_t  ngx_js_loc_members[] = {
    ...
    { "limitExcept",              "string[]",SAFE, REV|RQS, WL,
      "Array of method names; the setter requires an array" },
    ...
    { "clientBodyInFileOnly",     "string",  SAFE, REV|RQS, WL,
      "Tri-state: \"off\" | \"on\" | \"clean\", not a boolean" },
    ...
    { "keepaliveDisable",         "string[]",SAFE, REV|RQS, WL,
      "Array of browser names; the setter requires an array" },
    ...
    { "directio",                 "number|string", SAFE, REV|RQS, WL,
      "Byte threshold, or the string \"off\" when disabled" },
