...
> (current: **v5.12**, increment C UNDERWAY — C0 spike/gate PASSED (INCREMENT_C.md §4: maxim builds + a trivial fn compiles to a callable .so; libquickjs.a has js_jit_rt) +
