...
> (current: **v5.9**, increment B begins — B0 learning mode (js_tenant_mode learn +
> nginx.tenantLearning() onboarding harvest); v5.8 INCREMENT A COMPLETE — A3.1 + dogfood; v5.7 A4 denial log + audit→enforce; v5.6, the COMCON-lite core BUILT + TESTED through the
