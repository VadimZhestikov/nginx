...
Design-only edges remain: `realize`/`includeAt`/quotations, POM live-ops (rewrite/epochs,
increments D), `mediate` `rateLimit`/`transform`/`audit` flavors, `admit`'s test-phase
