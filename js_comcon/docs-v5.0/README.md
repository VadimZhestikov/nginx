...
> (current: **v5.12**, increment C UNDERWAY — C0 gate PASSED + C1.0 M-UNIFY analysis done (INCREMENT_C.md §4-5: same Bellard base → clean 3-way merge, benign opcode divergence; the engine merge C1.1-C1.4 is scoped/next) +
