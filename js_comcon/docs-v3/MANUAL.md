...
config — you file a **grant request** (§3.6).
...
`dev` · `request` · `evaluate` · `revoke [--cascade]` · `remove-subtree` · `snapshot` /
`rollback` · `rewrite` · `apply-overlay` · `attach` · `shadow-world` · `trust-report` ·
`export` · `optimize`
